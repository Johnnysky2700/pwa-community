...
const AddContact = () => {
  ...
  return (
    <div className="min-h-screen bg-[#f4ebff] flex flex-col p-4">
      {/* Header */}
      <div className="bg-primary text-white flex items-center p-4 rounded-b-3xl shadow">
        <IoArrowBackSharp
      ...
      <div className="mt-6 p-4 bg-white rounded-xl shadow">
        ...
        <button
          ...
          className="mt-4 px-6 py-2 rounded-full border-2 border-primary text-primary flex items-center justify-center gap-2 hover:bg-purple-100"
        >
          + Add Contacts
        </button>
      </div>
      ...
      <div className="mt-8">
        ...
        <div className="space-y-4">
          {mockContacts.map((contact) => (
            <div
              key={contact.id}
              className="bg-white flex items-center justify-between px-4 py-2 rounded-xl shadow"
            >
              <div className="flex items-center gap-4">
                <img
                  src={avatarImages[contact.avatar] || avatarImages['micheal.png']}  // Default to a fallback image
                  alt="avatar"
